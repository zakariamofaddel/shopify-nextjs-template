...
nextApp.prepare().then(async () => {
  ...
  //! Make sure all your images and media files are organized by type in the public folder
  //! This will allow you to add a route for each type of file
